  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'category', name: 'category-index', component: () => import('@/views/category/Index.vue'), meta: { title: '分类' } },
        { path: 'category/:name', name: 'category', component: () => import('@/views/category/List.vue'), meta: { title: '分类' } },
        { path: 'tag', name: 'tag-index', component: () => import('@/views/tag/Index.vue'), meta: { title: '标签' } },
