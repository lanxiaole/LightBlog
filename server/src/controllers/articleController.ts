...
export async function getAllArticles(req: Request, res: Response): Promise<void> {
  try {
    ...
    const { list, total } = await ArticleService.getAllArticles({
      keyword,
      categoryId,
      status,
      page,
...
export async function togglePin(req: Request, res: Response): Promise<void> {
  try {
    ...
    const success = await ArticleService.togglePin(id, isPinned);
...
export async function updateStatus(req: Request, res: Response): Promise<void> {
  try {
    ...
    const success = await ArticleService.updateArticleStatus(id, status);
